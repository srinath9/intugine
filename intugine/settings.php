            ...
            <section class="feature-page">
                <div class="container">
                    ...
                    <p class="privacy_content">
                        This Privacy Policy governs the manner in which Intugine collects,
                        uses, maintains and discloses information collected from users (each, a "User")
                        of the www.Intugine.com website ("Site"). This privacy policy applies to the Site
                        and all products and services offered by Intugine.<br><br>
                        ...
                        on our Site. Users may be asked for, as appropriate, name, email address, phone number,
                        address. Users may, however, visit our Site anonymously. We will collect personal
                        ...
                        except that it may prevent them from engaging in certain Site related activities.<br><br>
                        ...
                        of computer and technical information about Users means of connection
                        ...
                        Intugine may collect and use Users personal information for the following purposes:<br>
                        ...
                        We may use the email address to respond to their inquiries, questions, and/or other requests.<br><br>
                        ...
                        We employ other companies and individuals to perform functions on our behalf. Examples include fulfilling orders, delivering packages, sending postal mail 
                        and e-mail, analyzing data, providing marketing assistance, providing search results and links (including paid listings and links), processing credit card payments,
                        debit card payments 
                        and providing customer service. They have access to Personally Identifiable Information only to the extent needed to perform their functions, but may not use it for 
                        other purposes. By providing your Personally Identifiable Information to Intugine in order to obtain Intugine products or services, you acknowledge and agree that 
                        disclosure of your Personally Identifiable Information to such third parties may be necessary to provide you with such products and services, and you hereby consent 
                        to such disclosure.<br><br>

                        <strong>Changes to this privacy policy</strong><br>

                        Intugine has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.
                        <br><br>
                        ...
                        support@intugine.com            <br><br><br><br>
                    </p>
