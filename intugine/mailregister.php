...
<h2>Dear '.$_POST['reg_name'].' </h2>
<h3>We are glad to have you.<br>Your login Details are.</h3>
<p style="text-align: center;"><b>UserId</b> : '.$_POST['reg_email'].'</p>
<p style="text-align: center;"><b>Password</b> : '.$passkey.'</p><br>
    <br>
