...
$mail->AddAddress("kumar.sonoo@gmail.com","intern@intugine.com");

$mail->WordWrap = 50;                                 // set word wrap to 50 characters
$mail->IsHTML(true);                                  // set email format to HTML

$mail->Subject = "Query From Contact Section-Intugine";
...
<h2>Asked by '.$_POST['name'].' </h2>
<p style="text-align: center;"><span style="font-family:comic sans ms; font-size: medium;">"'.$_POST['body'].'"</span></p>
...
Name : 
Email-Id :";
echo '<script>alert("Dear ' .$_POST['name']. ',\n We have received your Query.")
